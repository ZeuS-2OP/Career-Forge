...
Original file is located at
    https://colab.research.google.com/drive/1nj4lp6EYkNES3EuV1pES6BI9oXiKUeGK
"""
...
def extract_students_from_excel(file_path):
    ...
    for row in worksheet.iter_rows(min_row=2, values_only=True):
        ...
        student = Student(
            ...
            academic_grades=float(student_data['academic_grades']),
            advanced_courses=int(student_data['advanced_courses']),
...
students = extract_students_from_excel('/content/algosheetex1.xlsx')
...
if not students:
    ...
    for student, rank in ranked_students:
        print(f"Rank {rank}: {student.name} (Academic Grades: {student.academic_grades}, Advanced Courses: {student.advanced_courses}, "
